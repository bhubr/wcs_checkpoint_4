         ...
         <section id="about">
            <div className="row">
               ...
               <div className="nine columns main-col">
                  ...
                  <p>I'm a junior developer based in Paris. I specialise in React, Node JS, SQL as well as UX/UI design. <br />
                  </p>
               </div>
               ...
               <div className='nine columns main-col'>
                  ...
                  <div className="row">
                     <div className="columns contact-details">
                        ...
                        <h2> Skills </h2>
                        <p>HTML5 | CSS3 | JS ES6 | React | React Hooks | Node JS | Express | Git | Github |
                        MySQL | MongoDB | Redux | MaterialUI | Bootstrap | Adobe Photoshop</p>
                  ...
                  <div className="row">
                     <div className="columns contact-details">
                        ...
                        <p className="address">
                           <span>Lena Hailin SIM</span><br />
                           <span>My adress<br />
                              Paris France, 00000
                           </span><br />
                           <span>07 83 81 75 77</span><br />
